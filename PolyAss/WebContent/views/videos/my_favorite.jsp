...
<div class="col">
<h1 class="text-center mt-4">Danh Sách Sản Phẩm Yêu Thích</h1>
			...
			<div style="width: 20%; margin: 0px auto;">
				<ul class="pagination">
					<li class="page-item"><a
						href="/PolyAss/user/MyFavoriteServlet?page=${ page1 - 1 }"
						class="page-link">Previous</a></li>
					<li class="page-item"><a class="page-link">${ page1 }</a></li>
					<li class="page-item"><a aria-selected="true"
						href="/PolyAss/user/MyFavoriteServlet?page=${ page1 + 1 }" id="next"
